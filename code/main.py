...
parser.add_argument('--moco-tra', default=0.07, type=float,
                    help='softmax temperature (default: 0.07)')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    model = seco.Contrast.MemorySeCo(args.skeleton_representation,opts.bi_gru_model_args,opts.agcn_model_args,opts.hcn_model_args,args.moco_dim,args.moco_k,args.moco_m,args.moco_t,args.moco_tra,args.mlp)
    ...
    criterion = seco.Contrast.NCESoftmaxLoss().cuda(args.gpu)
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (xq, x1, x2, x3, binary_order) in enumerate(train_loader):
        ...
        # compute output
        out_inter,out_intra, target,xq_logit_order = model(xq, x1, x2, x3)
